...
export default function MainInformation() {
  return (
    <div className="w-1/4 text-nowrap space-y-2">
      <div className="flex items-center w-full px-4 py-2 text-xl font-normal bg-primary text-white space-x-2 rounded-tl-md rounded-br-md">
