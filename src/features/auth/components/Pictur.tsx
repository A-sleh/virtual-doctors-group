...
export default function Pictur({
  ...
  return (
    <div className="pictur md:rounded-tl-[160px] gap-10 md:before:content-[''] ">
      <AnimateParentLeftEffect className="flex-col items-center mx-3 hidden md:flex">
        <AnimateScale>
          <img className="rounded-full w-80 " src={img} />
        </AnimateScale>
        <AnimateChildLeftEffect duration={0.3} className="text-white font-medium text-xl mt-5 ">
          The place where you will find
        </AnimateChildLeftEffect>
        <AnimateChildLeftEffect duration={0.8} className="text-white text-md mt-1 text-center w-80 px-10">
