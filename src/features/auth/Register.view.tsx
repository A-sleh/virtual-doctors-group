...
function Forms(){
  return<div className="grid grid-cols-2 gap-x-3 gap-y-4">
...
function Pictur({type , message } : {type : string , message: string}){
  return <div className="pictur" style={{borderStartStartRadius: "200px" }}>
    ...
    <div className="text-center absolute bottom-12">
      ...
      <a href="http://localhost:5173/auth/login"><Btn name={"Login"} color="text-primary" backgroundColor="bg-white"/></a>
    </div>
  </div>
}
